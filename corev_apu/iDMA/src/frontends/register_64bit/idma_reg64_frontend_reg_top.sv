...
module idma_reg64_frontend_reg_top #(
  ...
  logic conf_pv_wd;
  logic conf_pv_we;
  logic [3:0] conf_cache_qs;
  logic [3:0] conf_cache_wd;
  logic conf_cache_we;
  logic [1:0] conf_ttype_qs;
  logic [1:0] conf_ttype_wd;
  logic conf_ttype_we;
  logic status_qs;
  logic status_re;
  ...
  logic [63:0] wdata_wd;
  logic wdata_we;
  logic [63:0] n_trans_qs;
  logic [63:0] n_trans_wd;
  logic n_trans_we;
  ...
  always_comb begin
    ...
    addr_hit[7] = (reg_addr == IDMA_REG64_FRONTEND_RDATA_OFFSET);
    addr_hit[8] = (reg_addr == IDMA_REG64_FRONTEND_WDATA_OFFSET);
    addr_hit[9] = (reg_addr == IDMA_REG64_FRONTEND_N_TRANS_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[0] & (|(IDMA_REG64_FRONTEND_PERMIT[0] & ~reg_be))) |
               ...
               (addr_hit[8] & (|(IDMA_REG64_FRONTEND_PERMIT[8] & ~reg_be))) |
               (addr_hit[9] & (|(IDMA_REG64_FRONTEND_PERMIT[9] & ~reg_be)))));
  end
  ...
  assign conf_pv_we = addr_hit[3] & reg_we & !reg_error;
  assign conf_pv_wd = reg_wdata[3];

  assign conf_ttype_we = addr_hit[3] & reg_we & !reg_error;
  assign conf_ttype_wd = reg_wdata[5:4];

  assign conf_cache_we = addr_hit[3] & reg_we & !reg_error;
  assign conf_cache_wd = reg_wdata[9:6];
  ...
  assign wdata_we = addr_hit[8] & reg_we & !reg_error;
  assign wdata_wd = reg_wdata[63:0];

  assign n_trans_we = addr_hit[9] & reg_we & !reg_error;
  assign n_trans_wd = reg_wdata[63:0];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[3]: begin
        ...
        reg_rdata_next[3]   = conf_pv_qs;
        reg_rdata_next[5:4] = conf_ttype_qs;
        reg_rdata_next[9:6] = conf_cache_qs;
      end
      ...
      addr_hit[7]: begin
        reg_rdata_next[63:0] = rdata_qs;
      end

      addr_hit[8]: begin
        reg_rdata_next[63:0] = wdata_qs;
      end

      addr_hit[9]: begin
        reg_rdata_next[63:0] = n_trans_qs;
      end
